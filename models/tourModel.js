...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      unique: true,
      trim: true,
      maxlength: [40, 'A tour must have less or equal to 40 Charachters'],
      minlength: [
        10,
        'A tour must have greater than or equal to 10 Charachters',
      ],
    },
    slug: String,
    duration: {
    ...
    startDates: [Date],
    startLocation: {
      // * GeoJSON in order to specify GEO-SPATIAL DATA
      type: {
        type: String,
        default: 'Point',
        enum: ['Point'],
