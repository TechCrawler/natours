...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGVhY2hjcmF3bGVyIiwiYSI6ImNrZTl6aTdqNTA3b2Eyc3QwMjBoYTZuZmIifQ.rGVDxxPFKGw0AOFVRq6Drw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/teachcrawler/ckeb9t99d11wz1anv1ugyadbz',
    scrollZoom: false // center: [78.003537, 30.310459],
    // zoom: 10,
    // interactive: false,
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // set popup

    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("Day ".concat(loc.day, ": ").concat(loc.description)).addTo(map); // Extends the map bound to current location
...
// type wil be either password or data
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " saved succesfully!"));
              window.setTimeout(function () {
...
/* eslint-disable */
var stripe = Stripe('pk_test_51HOOaIC7EdJTNAoSYnCQwusUzfYoryO7H6XtfZXy09n5qP8kP2AH9rU18x5wlJRTWiU0ItTuXa4XuzTXcAT2Cn6F00T16BJ9mH');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            (0, _alerts.showAlert)('error', 'Could not able to process! try again later');
...
var userPassUpdateForm = document.querySelector('.form-user-settings');
...
if (userPassUpdateForm) {
  userPassUpdateForm.addEventListener('submit', /*#__PURE__*/function () {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              password = (_readOnlyError("password"), '');
              passwordCurrent = (_readOnlyError("passwordCurrent"), '');
              passwordConfirm = (_readOnlyError("passwordConfirm"), '');
